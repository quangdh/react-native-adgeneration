...
- (UIView *)createFBAdView:(FBNativeAd *)mediationFBAd
{
    if (self.locationType == @"2") {
        ...
        // セルの全体View
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(([self.bannerWidth floatValue]-300*ratio)/2,([self.bannerHeight floatValue]-250*ratio)/2,300*ratio,250*ratio)];
